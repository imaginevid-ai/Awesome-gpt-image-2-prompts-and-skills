# Contributing to Awesome GPT Image 2 Prompts and Skills

Thank you for helping improve the GPT Image 2 prompt collection.
...
- Explicit about GPT Image 2 provenance when the source claims a model result.

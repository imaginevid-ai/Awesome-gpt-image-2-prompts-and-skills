...
8. Explicit GPT Image 2 evidence in the post or quoted source. Prompt-only replies without model context stay in manual review.
...
1. Search focused GPT Image 2 queries with twitterapi.io.

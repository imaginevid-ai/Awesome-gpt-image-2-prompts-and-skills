# GPT Image 2 Repository Replication Plan
...
Build `imaginevid-ai/Awesome-gpt-image-2-prompts-and-skills` as an GPT Image 2 Library-branded clone of the reference repository architecture:
...
Reference: `the reference repository`
...
├── public/
│   └── images/
│       ├── gpt-image-2-prompts-cover-en.png
│       └── gpt-image-2-prompts-cover-zh.png
├── scripts/
│   ├── generate-readme.ts
...
```text
public/images/
└── gpt-image-2-library-prompt-skills-cross-promo.png
```
...
The reference README flow is adapted to a single GPT Image 2 Library-owned cover image:
...
- Replace all reference-repository text with GPT Image 2 Library/GPT Image 2 text.
- Replace remote reference-repository image URLs with generated local assets or GPT Image 2 Library-owned URLs.
- Do not promise a web gallery unless there is an actual GPT Image 2 Library URL ready.
...
- Keep `Try it now` links only if they can point to an GPT Image 2 page; otherwise omit or replace with source links.
...
- Same local cover image for every locale: `public/images/gpt-image-2-prompt-skills-cover.png`.
...
- local generated images under `public/images/` beyond the single GPT Image 2 Library cover.

Our version:

- generate one GPT Image 2 Library-owned cover asset,
...
- Copying reference-repository images, copy, links, or brand claims.
